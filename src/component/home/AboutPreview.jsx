...
export default function AboutPreview() {
    ...
    return (
        <section className="relative overflow-hidden py-28 bg-[#f8fafc]">
            ...
            "
                    >
                        EHCDT is a community-driven organization
                        dedicated to building sustainable futures
                        through compassion, education, and purposeful
                        action.
                    </p>
                </motion.div>
              ...
              "
                ...
                "
                            >
                                EHCDT is built by a diverse team of
                                thinkers, builders, and community
                                advocates who care deeply about helping
                                host communities grow. With a focus on
                                sustainability, transparency, and
                                people, we're creating solutions that
